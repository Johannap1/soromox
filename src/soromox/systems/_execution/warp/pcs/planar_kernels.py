...
def planar_local_operators_kernel(
    ...
    active_scales: wp.array2d(dtype=wp.float64),
    reference_strain: wp.array2d(dtype=wp.float64),
    operator_points: wp.array2d(dtype=wp.float64),
    epsilons: wp.array(dtype=wp.float64),
    adjoint_inverse: wp.array2d(dtype=wp.float64),
    transported_tangent: wp.array2d(dtype=wp.float64),
...
planar_local_operators = wp.jax_callable(_planar_local_operators, num_outputs=4)
...
def planar_persistent_chain_kernel(
    ...
    active_indices: wp.array2d(dtype=wp.int32),
    active_scales: wp.array2d(dtype=wp.float64),
    active_dof_ends: wp.array(dtype=wp.int32),
    qd: wp.array2d(dtype=wp.float64),
...
planar_persistent_chain = wp.jax_callable(_planar_persistent_chain, num_outputs=9)
